...
export const CRT_STYLES: Record<CrtVariant, CrtStyle> = {
  terminal: {
    curve: [0.035, 0.050], scanDensity: 0.35, scanDepth: 0.08, triadCss: 3.0, grille: 0.05, chroma: 0.03,
    bar: 0.020, flicker: 0.010, grain: 0.005, noise: 0, vignette: 0.40, mono: 0, gain: 1.35, halo: 0.00,
    sheen: [0.45, 0.95, 0.70], room: [0.008, 0.018, 0.012], background: "#020804",
